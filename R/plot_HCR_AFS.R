...
png(filename='figs_AFS/stepwiseHCR.png',width=6,height=4,units='in',res=600)
plot(1:12,1:12,bty='l',type='n',xaxt='n',yaxt='n',xlab='',
     ylab='',ylim=c(1,12), cex.lab=1.4)
title(ylab="Exploitation Rate", xlab="Spawner Abundance", line=1, cex.lab=1.5, family="Calibri Light")
abline(v=4,lty=3,col=adjustcolor('gray30',alpha.f = 0.5),lwd=2)
abline(v=8,lty=3,col=adjustcolor('gray30',alpha.f = 0.5),lwd=2)
...
png(filename='figs_AFS/noamberHCR.png',width=6,height=4,units='in',res=600)
plot(1:12,1:12,bty='l',type='n',xaxt='n',yaxt='n',xlab='',
     ylab='',ylim=c(1,12), cex.lab=1.4)
title(ylab="Exploitation Rate", xlab="Spawner Abundance", line=1, cex.lab=1.5, family="Calibri Light")
abline(v=4,lty=3,col=adjustcolor('gray30',alpha.f = 0.5),lwd=2)
