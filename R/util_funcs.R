...
add_status_format=function(hcrdat){
  ...
  hcrdat <- hcrdat %>%
  dplyr::mutate(
    aboveLowerassess = dplyr::case_when(
      aboveLowerBM == 1 & aboveLowerObsBM == 1 ~ "correct above lower BM",
      aboveLowerBM == 0 & aboveLowerObsBM == 1 ~ "wrong optimistic",
      aboveLowerBM == 1 & aboveLowerObsBM == 0 ~ "wrong pessimistic",
      TRUE ~ "correct below lower BM"
    ),

    aboveUpperassess = dplyr::case_when(
      aboveUpperBM == 1 & aboveUpperObsBM == 1 ~ "correct above upper BM",
      aboveUpperBM == 0 & aboveUpperObsBM == 1 ~ "wrong optimistic",
      aboveUpperBM == 1 & aboveUpperObsBM == 0 ~ "wrong pessimistic",
      TRUE ~ "correct below upper BM"
    ),

    wsp.status = dplyr::case_when(
      aboveLowerBM == 1 & aboveUpperBM == 1 ~ "green",
      aboveLowerBM == 1 & aboveUpperBM == 0 ~ "amber",
      TRUE ~ "red"
    ),

    status = dplyr::case_when(
      aboveLowerBM & aboveUpperBM & aboveLowerObsBM & aboveUpperObsBM ~ "green",
      aboveLowerBM & !aboveUpperBM & aboveLowerObsBM & !aboveUpperObsBM ~ "amber",
      !aboveLowerBM & !aboveUpperBM & !aboveLowerObsBM & !aboveUpperObsBM ~ "red",

      aboveLowerBM & aboveUpperBM & aboveLowerObsBM & !aboveUpperObsBM ~ "pessimistic green-> amber",
      aboveLowerBM & !aboveUpperBM & aboveLowerObsBM & aboveUpperObsBM ~ "optimistic amber -> green",

      aboveLowerBM & !aboveUpperBM & !aboveLowerObsBM & !aboveUpperObsBM ~ "pessimistic amber -> red",
      !aboveLowerBM & !aboveUpperBM & aboveLowerObsBM & !aboveUpperObsBM ~ "optimistic red -> amber",

      aboveLowerBM & aboveUpperBM & !aboveLowerObsBM & !aboveUpperObsBM ~ "pessimistic green -> red",
      !aboveLowerBM & !aboveUpperBM & aboveLowerObsBM & aboveUpperObsBM ~ "optimistic red -> green",
      TRUE ~ NA_character_
    )
  )
